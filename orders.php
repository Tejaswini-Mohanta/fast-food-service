            ...
            <nav class="navbar-color">
                <div class="nav-wrapper">
                    <ul class="left">                      
                      ...
                      <i class="fas fa-utensils"></i>Fast Food Junction </a> <span class="logo-text">Logo</span></h1></li>
                    </ul>
                    <ul class="right hide-on-med-and-down">                        
                        <li><a href="#"  class="waves-effect waves-block waves-light"><i class="mdi-editor-attach-money">
                            <?php echo $balance;?></i></a>
                        </li>
                    </ul>						
                </div>
            </nav>
