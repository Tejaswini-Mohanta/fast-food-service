...
<body>
            ...
            <nav class="navbar-color">
                <div class="nav-wrapper">
                    <ul class="left">                      
                      ...
                      <a href="index.php" class="brand-logo darken-1"><i class="fas fa-utensils"></i>Fast Food Junction </a>
    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold act"><a href="home.php" class="waves-effect waves-cyan"><i class="mdi-action-home"></i>Home</a>
            </li>	
            <li class="bold act"><a href="cart.php" class="waves-effect waves-cyan"><i class="mdi-action-add-shopping-cart"></i>Cart</a>
             </li>       
  ...
  <div class="container">
        <div class="card" id="item1">
            <img src="foodapp/dahi-bara-aloo-dum.jpg" alt="dahi-bara-aloo-dum">
            <div class="title">
                DAHI dahi-bara-aloo-dum
            </div>
            <div>
                <label>items:</label>
                <select>
                    ...
                    <option >2 plate</option>
                    <option >3 plate</option>
                    <option >4 plate</option>
                    <option >5 plate</option>
                </select>
            </div>
            <button onclick="addToCart(item1)">Add to Cart</button>
        </div>
        <div class="card" id="item2">
            <img src="foodapp/s-img-1.jpg" alt="dahi-bara-aloo-dum">
            <div class="title">
                DAHI dahi-bara-aloo-dum
            </div>
            <div>
        ...
        <div class="card" id="item3">
            <img src="foodapp/s-img-3.jpg" alt="dahi-bara-aloo-dum">
            <div class="title">
                DAHI dahi-bara-aloo-dum
            </div>
            <div>
  ...
  <footer class="page-footer">
    <div class="footer-copyright">
      <div class="container">
        <span>Copyright © 2022 <a class="grey-text text-lighten-4" href="#" target="_blank">Tejaswini & Shruti</a> All rights reserved.</span>
