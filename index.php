                ...
                <li class="no-padding">
                    <ul class="collapsible collapsible-accordion">
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan">
                          <i class="mdi-action-question-answer"></i> Tickets</a>
                            <div class="collapsible-body">
                                <ul>
...
<h1 class="credit"> created by <span> Tejaswini  </span> | all rights reserved! </h1>
...
<img src="foodapp/loader.gif" alt="">
</div> -->
<!-- <script type="text/javascript" src="js/foodaap.js"></script> -->
